...
function get_social_counts() {
    ...
    $.ajax({
        ...
        success: function(e) {
            ...
            a > 0 ? $("#facebook-span").html(a) : $("#facebook-span").hide(), $("#twitter-span").html(o), $("#gplus-span").html(s)
        }
    })
}
                ...
                return n(e, [{
                    ...
                    value: function(e) {
                        ...
                        var r = this.options,
                            ...
                            s = r.target,
                            l = r.targetModifier;
                        if (this.element = a, this.target = s, this.targetModifier = l, "viewport" === this.target ? (this.target = document.body, this.targetModifier = "visible") : "scroll-handle" === this.target && (this.target = document.body,
    ...
    function() {
        ...
        i.instances = {}, i.Type = function(e, t, n) {
            ...
            startDigest: function() {
                ...
                for (var i = 0; i < this.animations.length; i++) null === this.animations[i].animationObject.currentStep && (this.animations[i].animationObject.currentStep = 0), this.animations[i].animationObject.currentStep += 1 + t, this.animations[i].animationObject.currentStep > this.animations[i].animationObject.numSteps && (this.animations[i].animationObject.currentStep = this.animations[i].animationObject.numSteps), this.animations[i].animationObject.render(this.animations[i].chartInstance, this.animations[i].animationObject), this.animations[i].animationObject.currentStep == this.animations[i].animationObject.numSteps && (this.animations[i].animationObject.onAnimationComplete.call(this.animations[i].chartInstance),
                    this.animations.splice(i, 1), i--);
                var r = Date.now(),
...
dropdownSelectors.on({
    ...
    function(e) {
        ...
        function a(t, u, c, h) {
            ...
            function k() {
                var i;
                g.hiddenName === !0 ? (i = t.name, t.name = "") : (i = ["string" == typeof g.hiddenPrefix ? g.hiddenPrefix : "", "string" == typeof g.hiddenSuffix ? g.hiddenSuffix : "_submit"], i = i[0] + t.name + i[1]),
                    b._hidden = e('<input type=hidden name="' + i + '"' + (v.data("value") || t.value ? ' value="' + b.get("select", g.formatSubmit) + '"' : "") + ">")[0], v.on("change." + p.id, function() {
            ...
            Ce = function(e) {
                ...
                switch (delete e._source, e.type) {
                    ...
                    case "copy":
                        ...
                        !B["text/html"] && !B["text/plain"] && c && (u = c.value || c.outerHTML || c.innerHTML) && (l = c.value || c.textContent || c.innerText) ? (e.clipboardData.clearData(), e.clipboardData.setData("text/plain", l), u !== l && e.clipboardData.setData("text/html", u)) : !B["text/plain"] && e.target && (l = e.target.getAttribute("data-clipboard-text")) && (e.clipboardData.clearData(),
    ...
    function(e) {
        e.extend(e.fn, {
            ...
            attributeRules: function(t) {
                ...
                for (a in e.validator.methods) "required" === a ? (o = t.getAttribute(a), "" === o && (o = !0), o = !!o) : o = n.attr(a), /min|max/.test(a) && (null === r || /number|range|text/.test(r)) && (o = Number(o)),
